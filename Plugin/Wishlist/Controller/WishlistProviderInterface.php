<?php
namespace PF\WishlistGuest\Plugin\Wishlist\Controller;

use PF\Core\Helper\CoreHelper;
    ...
    public function afterGetWishlist(
        ...
        try {
            if (!$cookieWishlistCode = $this->wishlistManagement->getCookieWishlistCode()) {
                ...
                // log info:
                $this->coreHelper->getLogger()->debug('[PF_WishlistGuest] Created guest wishlist.', [
            ...
            $this->coreHelper->getLogger()->error('[PF_WishlistGuest] ' . $e->getMessage(), [
                'client_ip' => $this->remoteAddress->getRemoteAddress(),
            ]);
        }
