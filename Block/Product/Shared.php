<?php
namespace PF\WishlistGuest\Block\Product;

use PF\WishlistGuest\Api\WishlistManagementInterface;
use PF\WishlistGuest\Controller\Product\Merge;
use PF\WishlistGuest\Controller\Product\Shared as SharedController;
...
class Shared extends Template
{
     ...
     */
    const CACHE_WISHLIST_KEY = 'pf_wishlist_guest_data';

    /**
     * Cache "product block" data key.
     */
    const CACHE_PRODUCT_BLOCK_KEY = 'pf_wishlist_guest_product_block';
