<?php
namespace PF\WishlistGuest\Helper;
...
class Data extends AbstractHelper
{
     ...
     */
    const XML_PATH_ENABLED = 'pf_wishlist_guest/general/enabled';

    /**
     * Path for the "Enable for Guests" status.
     */
    const XML_PATH_IS_GUEST_WISHLIST_ENABLED = 'pf_wishlist_guest/general/is_guest_wishlist_enabled';

    /**
     * Path for the "Lifetime of Guest Wishlist" value.
     */
    const XML_PATH_GUEST_WISHLIST_LIFETIME = 'pf_wishlist_guest/general/guest_wishlist_lifetime';

    /**
     * Path for the "Share Wishlist by URL" status.
     */
    const XML_PATH_IS_SHARE_URL_ENABLED = 'pf_wishlist_guest/general/is_share_url_enabled';

    /**
     * Path for the "Merge Shared Products" status.
     */
    const XML_PATH_IS_SHARED_PRODUCT_MERGED = 'pf_wishlist_guest/general/is_shared_product_merged';

    /**
     * Path for the "Remove Old Guest Wishlists" status.
     */
    const XML_PATH_IS_OLD_GUEST_WISHLIST_REMOVED = 'pf_wishlist_guest/general/is_old_guest_wishlist_removed';

    /**
     * Path for the "Interval for Removing Old Wishlists" value.
     */
    const XML_PATH_GUEST_WISHLIST_REMOVING_INTERVAL = 'pf_wishlist_guest/general/guest_wishlist_removing_interval';
